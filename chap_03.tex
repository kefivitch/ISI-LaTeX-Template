...
\captionsetup{justification=centering}
	...
	\label{tab:perf-php}
\end{table}
\subsection[Traitement des exceptions]{Traitement des exceptions \cite{php-quora}}
...
\subsection[Support de 64 bits ]{Support de 64 bits \cite{php-quora}}
...
\subsection{Plus d'options pour les moteurs de stockage \cite{mysql-maria}}
