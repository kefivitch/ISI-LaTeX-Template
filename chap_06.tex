...
Le tableau suivant contient la description textuelle du cas d’utilisation «gestion des catégories»
\begin{table}[H]
	\centering
	\begin{tabular}{|l|l|}
		\hline
...
Le tableau suivant contient la description textuelle du ccas d’utilisation «gestion des PEF».
\begin{table}[H]
	\centering
	\begin{tabular}{|l|l|}
		\hline
...
\subsubsection{Description textuelle du cas d’utilisation «visibilité des PEF au boutique»}
