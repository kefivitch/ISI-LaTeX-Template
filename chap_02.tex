...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Acteur                           & Rôle                                                             \\ \hline
		Conseiller client réactif        & Consulter les PEF au fiche client                                \\ \hline
		Administrateur des habilitations & Gestion des utilisateurs                                         \\ \hline
		Administrateur & \begin{tabular}[c]{@{}l@{}}Consulter les PEF au fiche client\\ gérer toute la partie opérationnelle du projet\end{tabular} \\ \hline
